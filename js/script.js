$(function () {
	...
	*/
    ...
    function initialize() {
    	...
    	var myLatLng = {lat: 12.972651, lng: 77.600936};
        var mapOptions = {
            center: {lat: 12.972651, lng: 77.600936},
            zoom: 19,
            scrollwheel: false
        };
	...
	function geocodeAddress(geocoder, resultsMap) {
	  var address = "Aashirvad Centre,Opp. State Bank Of India Regional Office, St Marks Rd, Ashok Nagar, Bengaluru, Karnataka 560001, India";
	...
	function error(){
		console.log("something has gone wrong while fetching the location on the device");
	}
...
"https://maps.google.com/maps?f=q&
	...
	hl=en&
	geocode=&
	q=Aashirvad+Centre,+St+Mark's+Road,+Bangalore,+Karnataka,+India&
	aq=0&
	oq=aashir&
	sll=37.0625,
	-95.677068&
	sspn=40.052282,79.013672&
	ie=UTF8&
	hq=Aashirvad+Centre,&hnear=St+Mark's+Rd,+Bangalore,+Bangalore+Urban,+Karnataka+560001,+India&
	t=m&
	ll=12.972651,77.600936&
